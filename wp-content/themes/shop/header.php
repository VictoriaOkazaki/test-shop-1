...
<?php $shop_theme_options = shop_theme_options(); ?>
<div class="wrapper">
                ...
                <div class="row">
                    <div class="col-6 col-sm-4">
                        <div class="header-top-phone d-flex align-items-center h-100">
                            <?php if(!empty ($shop_theme_options['phone'])): ?>
                            <i class="fa-solid fa-mobile-screen"></i>
                            <a href="tel:+<?= str_replace(array(' ', '+', '-', '(', ')'), array('', '', '', '', ''), 
                            $shop_theme_options['phone']); ?>" 
                            class="ms-2"><?= $shop_theme_options['phone'] ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 d-none d-sm-block">
                        ...
                        <?php if(!empty ($shop_theme_options['youtube'])): ?>
                            <li>
                                <a href="<?= $shop_theme_options['youtube'] ?>">
                                    <i class="fa-brands fa-youtube"></i>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(!empty ($shop_theme_options['facebook'])): ?>
                            <li>
                                <a href="<?= $shop_theme_options['facebook'] ?>">
                                    <i class="fa-brands fa-facebook-f"></i>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(!empty ($shop_theme_options['instagram'])): ?>
                            <li>
                                <a href="<?= $shop_theme_options['instagram'] ?>">
    ...
    <div class="header-bottom sticky-top" id="header-nav">
        <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <div>
                    <a href="<?php get_template_directory_uri(  ) ?>/spisok-zhelanij/" class="btn p-1">
                        <i class="fa-solid fa-heart"></i>
                        <span class="badge text-bg-warning cart-badge bg-warning rounded-circle"><?= do_shortcode( '[ti_wishlist_products_counter]'); ?></span>
                    </a>
