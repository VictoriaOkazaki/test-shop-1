		...
		<div id="carousel" class="carousel slide carousel-fade">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item <?php if($i == 0): ?>active<?php endif;?>">
					...
					<img src="<?php the_post_thumbnail_url( 'full' );  ?>" class="d-block w-100" alt="<?php echo $alt; ?>">
		...
		<section class="featured-products">
			<div class="container-fluid">
				<div class="row mb-5">
					<div class="col-12">
						<h2 class="section-title">
							<span><?php _e('Featured products', 'shop'); ?></span>
						</h2>
					</div>
				</div>
					<?= do_shortcode( '[featured_products limit="8"]'); ?>
			</div>
		</section>
		...
		<section class="new-products">
			<div class="container-fluid">
				<div class="row mb-5">
					<div class="col-12">
						<h2 class="section-title">
							<span><?php _e('Recent Products', 'shop'); ?></span>
						</h2>
					</div>
				</div>
				<?= do_shortcode('[shop_recent_products limit="8"]'); ?>
			</div>
		</section>
